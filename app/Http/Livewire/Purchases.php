...
class Purchases extends Component
{
    ...
    public $provider_id, $type, $number_fact, $purchase_date, $tax = 12, $picture;
    public $product_id, $quantity, $buy_price, $sell_price, $subtotal, $taxiva, $itemtotal,$total; 
    public $selected_id, $search;
    public $providers, $provider, $products;
